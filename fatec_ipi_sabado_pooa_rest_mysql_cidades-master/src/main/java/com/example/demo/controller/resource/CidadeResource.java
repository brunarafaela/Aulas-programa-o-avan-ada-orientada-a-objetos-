...
public class CidadeResource {
	...
	@GetMapping ("letra/{nome}")
	public List<Cidade>  pelaLetra (@PathVariable String nome) {
		return cidadeRepo.getByLetra(nome);
	}
	
	//Obter uma cidade por sua latitude e longitude
	@GetMapping ("coordenadas/{latitude}/{longitude}")
	public List<Cidade> getByCoordenadas (@PathVariable String latitude, @PathVariable String longitude) {
		return (List<Cidade>) cidadeRepo.getByLatiLongi(latitude, longitude);
	}
